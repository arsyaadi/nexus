...
Modul **GraphEdge** digunakan untuk menangani proses bisnis terkait kapabilitas GraphEdge di dalam sistem.
...
- Memastikan proses GraphEdge berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data GraphEdge.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi GraphEdge |
...
- Parameter input GraphEdge valid.
- User memiliki kewenangan akses fitur GraphEdge.
...
```mermaid
flowchart TD
    A[Mulai Transaksi GraphEdge] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi GraphEdge.
...
- `src/types/index.ts#interface#GraphEdge`
