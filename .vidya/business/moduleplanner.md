...
Modul **ModulePlanner** digunakan untuk menangani proses bisnis terkait kapabilitas ModulePlanner di dalam sistem.
...
- Memastikan proses ModulePlanner berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data ModulePlanner.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi ModulePlanner |
...
- Parameter input ModulePlanner valid.
- User memiliki kewenangan akses fitur ModulePlanner.
...
```mermaid
flowchart TD
    A[Mulai Transaksi ModulePlanner] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi ModulePlanner.
