...
Modul **AGENTS.md** digunakan untuk menangani proses bisnis terkait kapabilitas AGENTS.md di dalam sistem.
...
- Memastikan proses AGENTS.md berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data AGENTS.md.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi AGENTS.md |
...
- Parameter input AGENTS.md valid.
- User memiliki kewenangan akses fitur AGENTS.md.
...
```mermaid
flowchart TD
    A[Mulai Transaksi AGENTS.md] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi AGENTS.md.
