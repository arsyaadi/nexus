...
Modul **ModuleWorker** digunakan untuk menangani proses bisnis terkait kapabilitas ModuleWorker di dalam sistem.
...
- Memastikan proses ModuleWorker berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data ModuleWorker.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi ModuleWorker |
...
- Parameter input ModuleWorker valid.
- User memiliki kewenangan akses fitur ModuleWorker.
...
```mermaid
flowchart TD
    A[Mulai Transaksi ModuleWorker] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi ModuleWorker.
...
- `src/executor/index.ts#class#ModuleWorker`
