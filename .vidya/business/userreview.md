...
Modul **UserReview** digunakan untuk menangani proses bisnis terkait kapabilitas UserReview di dalam sistem.
...
- Memastikan proses UserReview berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data UserReview.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi UserReview |
...
- Parameter input UserReview valid.
- User memiliki kewenangan akses fitur UserReview.
...
```mermaid
flowchart TD
    A[Mulai Transaksi UserReview] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi UserReview.
...
- `src/types/index.ts#interface#UserReviewHandler`
