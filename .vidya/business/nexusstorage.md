...
Modul **NexusStorage** digunakan untuk menangani proses bisnis terkait kapabilitas NexusStorage di dalam sistem.
...
- Memastikan proses NexusStorage berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data NexusStorage.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi NexusStorage |
...
- Parameter input NexusStorage valid.
- User memiliki kewenangan akses fitur NexusStorage.
...
```mermaid
flowchart TD
    A[Mulai Transaksi NexusStorage] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi NexusStorage.
...
- `src/storage/index.ts#class#NexusStorage`
