...
Modul **ModuleTask** digunakan untuk menangani proses bisnis terkait kapabilitas ModuleTask di dalam sistem.
...
- Memastikan proses ModuleTask berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data ModuleTask.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi ModuleTask |
...
- Parameter input ModuleTask valid.
- User memiliki kewenangan akses fitur ModuleTask.
...
```mermaid
flowchart TD
    A[Mulai Transaksi ModuleTask] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi ModuleTask.
...
- `src/types/index.ts#interface#ModuleTask`
