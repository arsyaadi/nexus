...
Modul **LocalGraphProvider** digunakan untuk menangani proses bisnis terkait kapabilitas LocalGraphProvider di dalam sistem.
...
- Memastikan proses LocalGraphProvider berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data LocalGraphProvider.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi LocalGraphProvider |
...
- Parameter input LocalGraphProvider valid.
- User memiliki kewenangan akses fitur LocalGraphProvider.
...
```mermaid
flowchart TD
    A[Mulai Transaksi LocalGraphProvider] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi LocalGraphProvider.
