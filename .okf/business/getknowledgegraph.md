...
Modul **getKnowledgeGraph** digunakan untuk menangani proses bisnis terkait kapabilitas getKnowledgeGraph di dalam sistem.
...
- Memastikan proses getKnowledgeGraph berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data getKnowledgeGraph.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi getKnowledgeGraph |
...
- Parameter input getKnowledgeGraph valid.
- User memiliki kewenangan akses fitur getKnowledgeGraph.
...
```mermaid
flowchart TD
    A[Mulai Transaksi getKnowledgeGraph] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi getKnowledgeGraph.
