...
Modul **Decision Making** digunakan untuk menangani proses bisnis terkait kapabilitas Decision Making di dalam sistem.
...
- Memastikan proses Decision Making berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data Decision Making.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi Decision Making |
...
- Parameter input Decision Making valid.
- User memiliki kewenangan akses fitur Decision Making.
...
```mermaid
flowchart TD
    A[Mulai Transaksi Decision Making] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi Decision Making.
