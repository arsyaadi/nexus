...
Modul **workflow** digunakan untuk menangani proses bisnis terkait kapabilitas workflow di dalam sistem.
...
- Memastikan proses workflow berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data workflow.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi workflow |
...
- Parameter input workflow valid.
- User memiliki kewenangan akses fitur workflow.
...
```mermaid
flowchart TD
    A[Mulai Transaksi workflow] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi workflow.
