...
Modul ****Antigravity / Cursor / Windsurf (`mcp_config.json` / `.mcp.json`)**** digunakan untuk menangani proses bisnis terkait kapabilitas **Antigravity / Cursor / Windsurf (`mcp_config.json` / `.mcp.json`)** di dalam sistem.
...
- Memastikan proses **Antigravity / Cursor / Windsurf (`mcp_config.json` / `.mcp.json`)** berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data **Antigravity / Cursor / Windsurf (`mcp_config.json` / `.mcp.json`)**.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi **Antigravity / Cursor / Windsurf (`mcp_config.json` / `.mcp.json`)** |
...
- Parameter input **Antigravity / Cursor / Windsurf (`mcp_config.json` / `.mcp.json`)** valid.
- User memiliki kewenangan akses fitur **Antigravity / Cursor / Windsurf (`mcp_config.json` / `.mcp.json`)**.
...
```mermaid
flowchart TD
    A[Mulai Transaksi **Antigravity / Cursor / Windsurf (`mcp_config.json` / `.mcp.json`)**] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi **Antigravity / Cursor / Windsurf (`mcp_config.json` / `.mcp.json`)**.
