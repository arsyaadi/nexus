...
Modul **NexusMetadata** digunakan untuk menangani proses bisnis terkait kapabilitas NexusMetadata di dalam sistem.
...
- Memastikan proses NexusMetadata berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data NexusMetadata.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi NexusMetadata |
...
- Parameter input NexusMetadata valid.
- User memiliki kewenangan akses fitur NexusMetadata.
...
```mermaid
flowchart TD
    A[Mulai Transaksi NexusMetadata] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi NexusMetadata.
