...
Modul **writeMetadata** digunakan untuk menangani proses bisnis terkait kapabilitas writeMetadata di dalam sistem.
...
- Memastikan proses writeMetadata berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data writeMetadata.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi writeMetadata |
...
- Parameter input writeMetadata valid.
- User memiliki kewenangan akses fitur writeMetadata.
...
```mermaid
flowchart TD
    A[Mulai Transaksi writeMetadata] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi writeMetadata.
