...
Modul **WorkerOutput** digunakan untuk menangani proses bisnis terkait kapabilitas WorkerOutput di dalam sistem.
...
- Memastikan proses WorkerOutput berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data WorkerOutput.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi WorkerOutput |
...
- Parameter input WorkerOutput valid.
- User memiliki kewenangan akses fitur WorkerOutput.
...
```mermaid
flowchart TD
    A[Mulai Transaksi WorkerOutput] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi WorkerOutput.
