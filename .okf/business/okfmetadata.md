...
Modul **OKFMetadata** digunakan untuk menangani proses bisnis terkait kapabilitas OKFMetadata di dalam sistem.
...
- Memastikan proses OKFMetadata berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data OKFMetadata.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi OKFMetadata |
...
- Parameter input OKFMetadata valid.
- User memiliki kewenangan akses fitur OKFMetadata.
...
```mermaid
flowchart TD
    A[Mulai Transaksi OKFMetadata] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi OKFMetadata.
