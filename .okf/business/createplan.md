...
Modul **createPlan** digunakan untuk menangani proses bisnis terkait kapabilitas createPlan di dalam sistem.
...
- Memastikan proses createPlan berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data createPlan.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi createPlan |
...
- Parameter input createPlan valid.
- User memiliki kewenangan akses fitur createPlan.
...
```mermaid
flowchart TD
    A[Mulai Transaksi createPlan] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi createPlan.
