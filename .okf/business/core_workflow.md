...
Modul **Core Workflow** digunakan untuk menangani proses bisnis terkait kapabilitas Core Workflow di dalam sistem.
...
- Memastikan proses Core Workflow berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data Core Workflow.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi Core Workflow |
...
- Parameter input Core Workflow valid.
- User memiliki kewenangan akses fitur Core Workflow.
...
```mermaid
flowchart TD
    A[Mulai Transaksi Core Workflow] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi Core Workflow.
