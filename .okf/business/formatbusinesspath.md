...
Modul **formatBusinessPath** digunakan untuk menangani proses bisnis terkait kapabilitas formatBusinessPath di dalam sistem.
...
- Memastikan proses formatBusinessPath berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data formatBusinessPath.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi formatBusinessPath |
...
- Parameter input formatBusinessPath valid.
- User memiliki kewenangan akses fitur formatBusinessPath.
...
```mermaid
flowchart TD
    A[Mulai Transaksi formatBusinessPath] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi formatBusinessPath.
