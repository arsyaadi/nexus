...
Modul **loadNexusPackage** digunakan untuk menangani proses bisnis terkait kapabilitas loadNexusPackage di dalam sistem.
...
- Memastikan proses loadNexusPackage berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data loadNexusPackage.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi loadNexusPackage |
...
- Parameter input loadNexusPackage valid.
- User memiliki kewenangan akses fitur loadNexusPackage.
...
```mermaid
flowchart TD
    A[Mulai Transaksi loadNexusPackage] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi loadNexusPackage.
...
- `src/exporter/loader.ts#func#loadNexusPackage`
