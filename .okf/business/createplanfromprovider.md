...
Modul **createPlanFromProvider** digunakan untuk menangani proses bisnis terkait kapabilitas createPlanFromProvider di dalam sistem.
...
- Memastikan proses createPlanFromProvider berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data createPlanFromProvider.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi createPlanFromProvider |
...
- Parameter input createPlanFromProvider valid.
- User memiliki kewenangan akses fitur createPlanFromProvider.
...
```mermaid
flowchart TD
    A[Mulai Transaksi createPlanFromProvider] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi createPlanFromProvider.
