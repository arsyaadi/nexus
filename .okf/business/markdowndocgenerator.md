...
Modul **MarkdownDocGenerator** digunakan untuk menangani proses bisnis terkait kapabilitas MarkdownDocGenerator di dalam sistem.
...
- Memastikan proses MarkdownDocGenerator berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data MarkdownDocGenerator.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi MarkdownDocGenerator |
...
- Parameter input MarkdownDocGenerator valid.
- User memiliki kewenangan akses fitur MarkdownDocGenerator.
...
```mermaid
flowchart TD
    A[Mulai Transaksi MarkdownDocGenerator] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi MarkdownDocGenerator.
...
- `src/generator/index.ts#class#MarkdownDocGenerator`
