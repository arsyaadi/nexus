...
Modul **loadVidyaPackage** digunakan untuk menangani proses bisnis terkait kapabilitas loadVidyaPackage di dalam sistem.
...
- Memastikan proses loadVidyaPackage berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data loadVidyaPackage.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi loadVidyaPackage |
...
- Parameter input loadVidyaPackage valid.
- User memiliki kewenangan akses fitur loadVidyaPackage.
...
```mermaid
flowchart TD
    A[Mulai Transaksi loadVidyaPackage] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi loadVidyaPackage.
