...
Modul **generator** digunakan untuk menangani proses bisnis terkait kapabilitas generator di dalam sistem.
...
- Memastikan proses generator berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data generator.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi generator |
...
- Parameter input generator valid.
- User memiliki kewenangan akses fitur generator.
...
```mermaid
flowchart TD
    A[Mulai Transaksi generator] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi generator.
