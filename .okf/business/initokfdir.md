...
Modul **initOKFDir** digunakan untuk menangani proses bisnis terkait kapabilitas initOKFDir di dalam sistem.
...
- Memastikan proses initOKFDir berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data initOKFDir.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi initOKFDir |
...
- Parameter input initOKFDir valid.
- User memiliki kewenangan akses fitur initOKFDir.
...
```mermaid
flowchart TD
    A[Mulai Transaksi initOKFDir] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi initOKFDir.
