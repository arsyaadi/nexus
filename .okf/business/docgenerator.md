...
Modul **DocGenerator** digunakan untuk menangani proses bisnis terkait kapabilitas DocGenerator di dalam sistem.
...
- Memastikan proses DocGenerator berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data DocGenerator.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi DocGenerator |
...
- Parameter input DocGenerator valid.
- User memiliki kewenangan akses fitur DocGenerator.
...
```mermaid
flowchart TD
    A[Mulai Transaksi DocGenerator] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi DocGenerator.
