...
Modul **main** digunakan untuk menangani proses bisnis terkait kapabilitas main di dalam sistem.
...
- Memastikan proses main berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data main.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi main |
...
- Parameter input main valid.
- User memiliki kewenangan akses fitur main.
...
```mermaid
flowchart TD
    A[Mulai Transaksi main] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi main.
