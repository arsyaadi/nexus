...
Modul **formatBusinessDoc** digunakan untuk menangani proses bisnis terkait kapabilitas formatBusinessDoc di dalam sistem.
...
- Memastikan proses formatBusinessDoc berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data formatBusinessDoc.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi formatBusinessDoc |
...
- Parameter input formatBusinessDoc valid.
- User memiliki kewenangan akses fitur formatBusinessDoc.
...
```mermaid
flowchart TD
    A[Mulai Transaksi formatBusinessDoc] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi formatBusinessDoc.
