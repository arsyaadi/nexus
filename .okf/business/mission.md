...
Modul **Mission** digunakan untuk menangani proses bisnis terkait kapabilitas Mission di dalam sistem.
...
- Memastikan proses Mission berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data Mission.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi Mission |
...
- Parameter input Mission valid.
- User memiliki kewenangan akses fitur Mission.
...
```mermaid
flowchart TD
    A[Mulai Transaksi Mission] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi Mission.
