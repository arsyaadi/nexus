...
Modul **VidyaExporter** digunakan untuk menangani proses bisnis terkait kapabilitas VidyaExporter di dalam sistem.
...
- Memastikan proses VidyaExporter berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data VidyaExporter.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi VidyaExporter |
...
- Parameter input VidyaExporter valid.
- User memiliki kewenangan akses fitur VidyaExporter.
...
```mermaid
flowchart TD
    A[Mulai Transaksi VidyaExporter] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi VidyaExporter.
