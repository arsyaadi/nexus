...
Modul **Business Flow** digunakan untuk menangani proses bisnis terkait kapabilitas Business Flow di dalam sistem.
...
- Memastikan proses Business Flow berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data Business Flow.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi Business Flow |
...
- Parameter input Business Flow valid.
- User memiliki kewenangan akses fitur Business Flow.
...
```mermaid
flowchart TD
    A[Mulai Transaksi Business Flow] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi Business Flow.
