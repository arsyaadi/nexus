...
Modul **OKFWorkflowOrchestrator** digunakan untuk menangani proses bisnis terkait kapabilitas OKFWorkflowOrchestrator di dalam sistem.
...
- Memastikan proses OKFWorkflowOrchestrator berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data OKFWorkflowOrchestrator.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi OKFWorkflowOrchestrator |
...
- Parameter input OKFWorkflowOrchestrator valid.
- User memiliki kewenangan akses fitur OKFWorkflowOrchestrator.
...
```mermaid
flowchart TD
    A[Mulai Transaksi OKFWorkflowOrchestrator] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi OKFWorkflowOrchestrator.
