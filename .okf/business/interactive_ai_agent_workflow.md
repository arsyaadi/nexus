...
Modul **Interactive AI Agent Workflow** digunakan untuk menangani proses bisnis terkait kapabilitas Interactive AI Agent Workflow di dalam sistem.
...
- Memastikan proses Interactive AI Agent Workflow berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data Interactive AI Agent Workflow.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi Interactive AI Agent Workflow |
...
- Parameter input Interactive AI Agent Workflow valid.
- User memiliki kewenangan akses fitur Interactive AI Agent Workflow.
...
```mermaid
flowchart TD
    A[Mulai Transaksi Interactive AI Agent Workflow] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi Interactive AI Agent Workflow.
