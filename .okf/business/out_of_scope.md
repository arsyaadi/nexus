...
Modul **Out of Scope** digunakan untuk menangani proses bisnis terkait kapabilitas Out of Scope di dalam sistem.
...
- Memastikan proses Out of Scope berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data Out of Scope.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi Out of Scope |
...
- Parameter input Out of Scope valid.
- User memiliki kewenangan akses fitur Out of Scope.
...
```mermaid
flowchart TD
    A[Mulai Transaksi Out of Scope] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi Out of Scope.
