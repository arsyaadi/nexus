...
Modul **DocxExporter** digunakan untuk menangani proses bisnis terkait kapabilitas DocxExporter di dalam sistem.
...
- Memastikan proses DocxExporter berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data DocxExporter.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi DocxExporter |
...
- Parameter input DocxExporter valid.
- User memiliki kewenangan akses fitur DocxExporter.
...
```mermaid
flowchart TD
    A[Mulai Transaksi DocxExporter] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi DocxExporter.
