...
Modul **WorkerInput** digunakan untuk menangani proses bisnis terkait kapabilitas WorkerInput di dalam sistem.
...
- Memastikan proses WorkerInput berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data WorkerInput.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi WorkerInput |
...
- Parameter input WorkerInput valid.
- User memiliki kewenangan akses fitur WorkerInput.
...
```mermaid
flowchart TD
    A[Mulai Transaksi WorkerInput] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi WorkerInput.
...
- `src/executor/index.ts#interface#WorkerInput`
