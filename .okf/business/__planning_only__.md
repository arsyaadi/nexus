...
Modul ****Planning Only**** digunakan untuk menangani proses bisnis terkait kapabilitas **Planning Only** di dalam sistem.
...
- Memastikan proses **Planning Only** berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data **Planning Only**.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi **Planning Only** |
...
- Parameter input **Planning Only** valid.
- User memiliki kewenangan akses fitur **Planning Only**.
...
```mermaid
flowchart TD
    A[Mulai Transaksi **Planning Only**] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi **Planning Only**.
