...
Modul **mcp** digunakan untuk menangani proses bisnis terkait kapabilitas mcp di dalam sistem.
...
- Memastikan proses mcp berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data mcp.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi mcp |
...
- Parameter input mcp valid.
- User memiliki kewenangan akses fitur mcp.
...
```mermaid
flowchart TD
    A[Mulai Transaksi mcp] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi mcp.
