...
Modul **KnowledgeGraph** digunakan untuk menangani proses bisnis terkait kapabilitas KnowledgeGraph di dalam sistem.
...
- Memastikan proses KnowledgeGraph berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data KnowledgeGraph.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi KnowledgeGraph |
...
- Parameter input KnowledgeGraph valid.
- User memiliki kewenangan akses fitur KnowledgeGraph.
...
```mermaid
flowchart TD
    A[Mulai Transaksi KnowledgeGraph] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi KnowledgeGraph.
...
- `src/types/index.ts#interface#KnowledgeGraph`
