...
Modul **GraphProvider** digunakan untuk menangani proses bisnis terkait kapabilitas GraphProvider di dalam sistem.
...
- Memastikan proses GraphProvider berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data GraphProvider.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi GraphProvider |
...
- Parameter input GraphProvider valid.
- User memiliki kewenangan akses fitur GraphProvider.
...
```mermaid
flowchart TD
    A[Mulai Transaksi GraphProvider] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi GraphProvider.
...
- `src/types/index.ts#interface#GraphProvider`
