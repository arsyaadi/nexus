...
Modul **GraphNode** digunakan untuk menangani proses bisnis terkait kapabilitas GraphNode di dalam sistem.
...
- Memastikan proses GraphNode berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data GraphNode.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi GraphNode |
...
- Parameter input GraphNode valid.
- User memiliki kewenangan akses fitur GraphNode.
...
```mermaid
flowchart TD
    A[Mulai Transaksi GraphNode] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi GraphNode.
...
- `src/types/index.ts#interface#GraphNode`
