...
Modul **Success Criteria** digunakan untuk menangani proses bisnis terkait kapabilitas Success Criteria di dalam sistem.
...
- Memastikan proses Success Criteria berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data Success Criteria.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi Success Criteria |
...
- Parameter input Success Criteria valid.
- User memiliki kewenangan akses fitur Success Criteria.
...
```mermaid
flowchart TD
    A[Mulai Transaksi Success Criteria] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi Success Criteria.
