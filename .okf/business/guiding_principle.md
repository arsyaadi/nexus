...
Modul **Guiding Principle** digunakan untuk menangani proses bisnis terkait kapabilitas Guiding Principle di dalam sistem.
...
- Memastikan proses Guiding Principle berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data Guiding Principle.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi Guiding Principle |
...
- Parameter input Guiding Principle valid.
- User memiliki kewenangan akses fitur Guiding Principle.
...
```mermaid
flowchart TD
    A[Mulai Transaksi Guiding Principle] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi Guiding Principle.
