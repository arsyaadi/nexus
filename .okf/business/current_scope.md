...
Modul **Current Scope** digunakan untuk menangani proses bisnis terkait kapabilitas Current Scope di dalam sistem.
...
- Memastikan proses Current Scope berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data Current Scope.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi Current Scope |
...
- Parameter input Current Scope valid.
- User memiliki kewenangan akses fitur Current Scope.
...
```mermaid
flowchart TD
    A[Mulai Transaksi Current Scope] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi Current Scope.
