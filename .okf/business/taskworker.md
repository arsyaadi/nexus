...
Modul **TaskWorker** digunakan untuk menangani proses bisnis terkait kapabilitas TaskWorker di dalam sistem.
...
- Memastikan proses TaskWorker berjalan sesuai aturan perusahaan.
- Mengelola transaksi dan validasi data TaskWorker.
...
| Aktor | Peran |
|--------|------|
| User / Customer | Memulai transaksi / interaksi TaskWorker |
...
- Parameter input TaskWorker valid.
- User memiliki kewenangan akses fitur TaskWorker.
...
```mermaid
flowchart TD
    A[Mulai Transaksi TaskWorker] --> B[Input Data Parameter]
...
Pengguna memasukkan informasi atau payload transaksi TaskWorker.
...
- `src/executor/index.ts#interface#TaskWorker`
